...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.example', name: 'example-neoforge-26.1', version: '26.1.0.0'
     // Fabric
     implementation group: 'net.darkhax.example', name: 'example-fabric-26.1', version: '26.1.0.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.example', name: 'example-common-26.1', version: '26.1.0.0'
}
```
